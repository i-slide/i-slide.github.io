define({
  ...
  "summaryTab": {
    ...
    "saveToLayerHelp": "<p>سيتم عرض الطبقة ذات الشروط التالية:<br/><ul><li>يجب أن يكون للطبقة قدرات تحريرية أي \"الإنشاء\" و\"الحذف\" و\"التحديث\"</li><li>يجب أن يكون للطبقة حقلان باسم ونوع البيانات:</li><ul><li>اسم المعلمة (حقل نوع السلسلة)</li><li>معرف المشروع (حقل نوع الدليل)</li></ul></ul><p/>",
